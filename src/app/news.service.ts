...
import { catchError, mergeMap, tap, map, take } from "rxjs/operators";
...
export class NewsService {
  news: News[] = [
    ...
    },
    {
      ...
      descendants: 18,
      id: 11510199,
      kids: [11510987, 11510304, 11510524, 11511125, 11510581],
      score: 113,
      time: 1460806341,
      title:
    ...
    },
    {
      ...
      descendants: 10,
      id: 11510207,
      kids: [11510865, 11510360, 11511147, 11510771, 11510802],
      score: 38,
      time: 1460806537,
      title:
        "Chrome extension â€“ Replaces new tab with random GitHub user's profile",
      type: "story",
    ...
    },
    {
      ...
      descendants: 3,
      id: 11510072,
      kids: [11510956, 11510927, 11510825],
      score: 32,
      time: 1460802910,
    ...
    },
    {
      ...
      descendants: 29,
      id: 11509921,
      kids: [11510020, 11510986, 11510645, 11510019, 11510518, 11511086],
      score: 225,
      time: 1460798527,
      title:
    ...
    },
    {
      ...
      descendants: 13,
      id: 11508755,
      kids: [11510515, 11509133, 11511089, 11510195, 11509748],
      score: 112,
      time: 1460768850,
  ...
  getNewsRemote(page: number) {
    ...
    return this.getNewsHandle(this.newsIDs.slice(page * 10, page * 10 + 20));
  }
